...
2. **API key** from OpenAI or Anthropic
3. **Merit Analyzer installed** (`pip install merit-analyzer`)
...
export MODEL_VENDOR=openai
export INFERENCE_VENDOR=openai
```
...
Merit Analyzer makes LLM API calls:
